...
// Fungsi untuk mengecek apakah user memiliki akses yang valid
function checkAdminAccess() {
    if (!isset($_SESSION['nama_admin']) || $_SESSION['level'] !== 'admin') {
...
// Panggil fungsi untuk mengecek akses
checkAdminAccess();
?>
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-title">Data &amp; Kelas</li>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="./admin/kenaikan_kelas.php" class="submenu-link">Kenaikan Kelas</a>
                        ...
                        <div class="card">
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">Wallskiee</h5>
                                        <h6 class="text-muted mb-0">@skiewall</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
